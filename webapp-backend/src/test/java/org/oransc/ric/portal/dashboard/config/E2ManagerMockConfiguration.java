...
public class E2ManagerMockConfiguration {
	...
	public E2ManagerApiBuilder e2ManagerApiBuilder() {
		...
		final NodebApi mockNodebApi1 = nodebApi(RICInstanceMockConfiguration.INSTANCE_KEY_1);
		when(mockBuilder.getNodebApi(RICInstanceMockConfiguration.INSTANCE_KEY_1)).thenReturn(mockNodebApi1);
		final NodebApi mockNodebApi2 = nodebApi(RICInstanceMockConfiguration.INSTANCE_KEY_2);
		when(mockBuilder.getNodebApi(RICInstanceMockConfiguration.INSTANCE_KEY_2)).thenReturn(mockNodebApi2);
		return mockBuilder;
	}
