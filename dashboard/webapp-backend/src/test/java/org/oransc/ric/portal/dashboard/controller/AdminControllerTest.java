...
public class AdminControllerTest extends AbstractControllerTest {
	...
	public void deleteAppStatsTest() {
		...
		uri = buildUri(null, AdminController.CONTROLLER_PATH, DashboardConstants.RIC_INSTANCE_KEY, RICInstanceMockConfiguration.INSTANCE_KEY_1, 
				AdminController.STATAPPMETRIC_METHOD, DashboardConstants.APP_ID, String.valueOf(statToDelete));
		logger.info("Invoking uri {}", uri);
