 ...
 * ========================LICENSE_END===================================
 */
package org.rancodev.ric.dash.controller;
...
import org.rancodev.ric.dash.DashboardConstants;
import org.rancodev.ric.dash.model.DashboardResponse;
import org.rancodev.ric.dash.model.DelayTransport;
import org.rancodev.ric.dash.model.ErrorTransport;
import org.rancodev.ric.dash.model.LoadTransport;
import org.rancodev.ric.dash.model.MetricsTransport;
import org.rancodev.ric.dash.model.PathTransport;
import org.rancodev.ric.dash.model.SuccessTransport;
import org.rancodev.ric.dash.model.UrlTransport;
...
public class A1MediationController {
	...
	@ApiOperation(value = "Gets the A1 Mediation URL.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_URL, method = RequestMethod.GET)
	public DashboardResponse getA1MediationUrl() {
		return new UrlTransport(a1MediationUrl);
	}

	@ApiOperation(value = "Sets the A1 Mediation URL.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_URL, method = RequestMethod.PUT)
	public DashboardResponse setA1MediationUrl(@RequestBody UrlTransport st, HttpServletResponse response) {
		try {
	...
	@ApiOperation(value = "Gets the A1 Mediation delay path.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_DELAY_PATH, method = RequestMethod.GET)
	public DashboardResponse getA1MediationDelayPath() {
		return new PathTransport(a1MediationDelayPath);
	}

	@ApiOperation(value = "Sets the A1 Mediation delay path.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_DELAY_PATH, method = RequestMethod.PUT)
	public DashboardResponse setA1MediationDelayPath(@RequestBody PathTransport st) {
		this.a1MediationDelayPath = st.getPath();
		return new SuccessTransport(HttpServletResponse.SC_OK, null);
	}

	@ApiOperation(value = "Gets the A1 Mediation load path.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_LOAD_PATH, method = RequestMethod.GET)
	public DashboardResponse getA1MediationLoadPath() {
		return new PathTransport(a1MediationLoadPath);
	}

	@ApiOperation(value = "Sets the A1 Mediation load path.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_LOAD_PATH, method = RequestMethod.PUT)
	public DashboardResponse setA1MediationLoadPath(@RequestBody PathTransport st) {
		this.a1MediationLoadPath = st.getPath();
		return new SuccessTransport(HttpServletResponse.SC_OK, null);
	}

	@ApiOperation(value = "Gets the A1 Mediation metrics path.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_METRICS_PATH, method = RequestMethod.GET)
	public DashboardResponse getA1MediationMetricsPath() {
		return new PathTransport(a1MediationMetricsPath);
	}

	@ApiOperation(value = "Sets the A1 Mediation metrics path.", response = DashboardResponse.class)
	@RequestMapping(value = A1_MEDIATION_METRICS_PATH, method = RequestMethod.PUT)
	public DashboardResponse setA1MediationMetricsPath(@RequestBody PathTransport st) {
