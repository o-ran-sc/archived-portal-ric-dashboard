...
public class A1Controller {
	...
	public Object getAllPolicyTypes(HttpServletResponse response) {
		...
		OutputPTidsListSchema outputPTidsListSchema = a1ControllerApi.a1ControllerGetAllPolicyTypes(inputSchema);
		...
		for (Integer policyTypeId : policyTypeIds) {
			...
			OutputDescNamePTSchema controllerGetPolicyType = a1ControllerApi.a1ControllerGetPolicyType(typeSchema);
	...
	public Object getPolicyInstances(@PathVariable(POLICY_TYPE_ID_NAME) String policyTypeIdString) {
		...
		OutputPIidsListSchema controllerGetAllInstancesForType = a1ControllerApi.a1ControllerGetAllInstancesForType(inputSchema);
		...
		for (String instanceId : instancesForType) {
			...
			OutputPISchema policyInstance = a1ControllerApi.a1ControllerGetPolicyInstance(instanceInputSchema);
			PolicyInstance instance = new PolicyInstance(instanceId, policyInstance.getOutput().getPolicyInstance());
