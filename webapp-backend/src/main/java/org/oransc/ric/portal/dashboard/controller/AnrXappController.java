...
public class AnrXappController {
	...
	@RequestMapping(value = "/cell/cellIdentifier/{cellIdentifier}", method = RequestMethod.GET)
	public NeighborCellRelationTable queryNcrtServingCell(@PathVariable("cellIdentifier") String cellIdentifier, //
			@RequestParam(name = START_INDEX, required = false) String startIndex, //
			@RequestParam(name = LIMIT, required = false) Integer limit,
	...
	@RequestMapping(value = "/cell/cellIdentifier/{cellIdentifier}", method = RequestMethod.PUT)
	public void modifyNcrt(@PathVariable("cellIdentifier") String cellIdentifier, //
	...
	@RequestMapping(value = "/cell/cellIdentifier/{cellIdentifier}", method = RequestMethod.DELETE)
	public void modifyNcrt(@PathVariable("cellIdentifier") String cellIdentifier, //
