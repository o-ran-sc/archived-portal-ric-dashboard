...
public class AppStatsManager {
	 ...
	 */
	public synchronized AppStats createStats(String instanceKey, StatsDetailsTransport statsSetupRequest) throws StatsManagerException, IOException{
		...
		newAppStat = new AppStats(instanceKey, new StatsDetailsTransport(lastCreatedStatIndex,
