...
export class InstanceSelectorService {
  ...
  // This method is used by most of service.
  // If need call those services at component ngOnInit, please subscribe selectedInstanceKey from getSelectedInstancekey() method,
  // and make sure this BehaviorSubject has non empty value
