...
public class A1MediatorClientTest {
	...
	public void demo() {
		...
		try {
			...
			System.out.println(
					"a1ControllerGetPolicyInstance answered code {} " + apiClient.getStatusCode().toString() + ", content " + o.toString());
		...
		try {
			...
			System.out.println("a1ControllerCreateOrReplacePolicyInstance answered: " + apiClient.getStatusCode().toString());
			Assertions.assertTrue(apiClient.getStatusCode().is2xxSuccessful());
		} catch (RestClientException e) {
