...
public class AdminController {
	...
	@Secured({ DashboardConstants.ROLE_ADMIN, DashboardConstants.ROLE_STANDARD })
	public List<Stats> getStats(@PathVariable(DashboardConstants.RIC_INSTANCE_KEY) String instanceKey) {
		logger.debug("getStatsDetails for instance {}", instanceKey);
		return statsManager.getStatsbyInstance(instanceKey);
	...
	@Secured({ DashboardConstants.ROLE_ADMIN, DashboardConstants.ROLE_STANDARD })
	public Stats getStatsById(@PathVariable(DashboardConstants.RIC_INSTANCE_KEY) String instanceKey,
	...
	public IDashboardResponse createStats(@PathVariable(DashboardConstants.RIC_INSTANCE_KEY) String instanceKey,
		...
		return statsManager.createStats(instanceKey, statsSetupRequest);
	}
	...
	public void updateStats(@PathVariable(DashboardConstants.RIC_INSTANCE_KEY) String instanceKey,
		...
		statsManager.updateStats(instanceKey, statsSetupRequest);
	}
	...
	public IDashboardResponse deleteStats(@PathVariable(DashboardConstants.RIC_INSTANCE_KEY) String instanceKey,
		...
		return statsManager.deleteStats(instanceKey, appId);
	}
}