...
import { StatsDetails, StatsResponse } from '../../interfaces/e2-mgr.types';
...
export class StatsService {
    ...
    getAppMetricsById(instanceKey: string, appId: number): Observable<StatsResponse> {
        const path = this.dashboardSvc.buildPath(this.component, instanceKey, this.appId, appId, this.appmetricPath);
        return this.httpClient.get<StatsResponse>(path);
      }
