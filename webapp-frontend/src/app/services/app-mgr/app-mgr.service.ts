...
export class AppMgrService {
  ...
  getDeployable(): Observable<XMDeployableApp[]> {
    return this.httpClient.get<XMDeployableApp[]>(this.instanceSelectorService.getBasePath() + '/appmgr/xapps/list');
  }

  getDeployed(): Observable<XMDeployedApp[]> {
    return this.httpClient.get<XMDeployedApp[]>(this.instanceSelectorService.getBasePath() + '/appmgr/xapps');
  }

  deployXapp(name: string): Observable<HttpResponse<Object>> {
    const xappInfo: XMXappInfo = { name: name };
    return this.httpClient.post((this.instanceSelectorService.getBasePath() + '/appmgr/xapps'), xappInfo, { observe: 'response' });
  }

  undeployXapp(name: string): Observable<HttpResponse<Object>> {
    return this.httpClient.delete((this.instanceSelectorService.getBasePath() + '/appmgr/xapps'+ '/' + name), { observe: 'response' });
  }
  ...
  putConfig(config: any): Observable<HttpResponse<Object>> {
    return this.httpClient.put((this.instanceSelectorService.getBasePath() + '/appmgr/config' ), config, { observe: 'response' });
  }
