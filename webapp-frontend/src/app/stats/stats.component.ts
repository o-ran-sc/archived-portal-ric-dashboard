...
export class StatsComponent implements OnInit {
    ...
    load;
    delay;
    //kibanaxAppMetrics: string;
    kibanaxAppMetrics : SafeResourceUrl;
    ...
    ngOnInit() {
        ...
        this.service.getxAppMetricsUrl().subscribe((res:DashboardSuccessTransport) => {
            this.kibanaxAppMetrics = this.sanitize.bypassSecurityTrustResourceUrl(res.data);
        });
    }
