...
/**
 * Services for calling the Dashboard's Non Realtime-RIC endpoints.
 */
@Injectable({
  providedIn: 'root'
})
export class PolicyService {
   ...
   * @returns Observable that should yield an NonRRPolicyControl
   */
  getPolicy(policyTypeId: number, policyInstanceId: string): Observable<PolicyInstance> {
   ...
   * @param policy an instance of NonRRPolicyControl
