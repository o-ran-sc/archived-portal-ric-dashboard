...
public class AdminController {
	...
	@Secured({ DashboardConstants.ROLE_ADMIN, DashboardConstants.ROLE_STANDARD })
	public ResponseEntity<IDashboardResponse> getAppMetricsUrl(@RequestParam String app) {
		...
		return new ResponseEntity<>(
				new ErrorTransport(HttpStatus.BAD_REQUEST.ordinal(), "Client provided app name is invalid as: " + app),
