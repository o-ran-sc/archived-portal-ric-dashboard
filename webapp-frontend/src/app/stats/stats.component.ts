...
export class StatsComponent implements OnInit {
    ...
    load;
    delay;
    kibanaACAppMetrics : SafeResourceUrl;
    ...
    ngOnInit() {
        ...
        this.service.getxPPMetricsUrl('AC').subscribe((res:DashboardSuccessTransport) => {
            this.kibanaACAppMetrics = this.sanitize.bypassSecurityTrustResourceUrl(res.data);
        });
    }
