...
export class PolicyInstanceComponent implements OnInit {
    ...
    constructor(
        ...
        this.policyTypeId = parseInt(this.route.snapshot.paramMap.get( 'policy_type_id' ), 10);
        this.createSchema = this.route.snapshot.paramMap.get( 'create_schema' );
    }
    ...
    modifyInstance( instance: PolicyInstance ): void {
        const policy_type_id = this.policyTypeId;
        const create_schema = this.createSchema;
