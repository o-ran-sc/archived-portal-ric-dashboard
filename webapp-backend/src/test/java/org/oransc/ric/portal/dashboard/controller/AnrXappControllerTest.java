...
public class AnrXappControllerTest extends AbstractControllerTest {
	...
	public void gnodebsTest() {
		...
		logger.info("Invoking {}", uri);
		GgNodeBTable list = testRestTemplateUser().getForObject(uri, GgNodeBTable.class);
	...
	public void ncrtGetTest() {
		...
		logger.info("Invoking {}", uri);
		NeighborCellRelationTable table = testRestTemplateUser().getForObject(uri, NeighborCellRelationTable.class);
