...
/**
 * Provides a method to get a list of pods using RestTemplate. Can be used
 * insecurely; i.e., ignore SSL errors, which is a workaround for self-signed
 * certificates in CAAS-Ingres.
 */
