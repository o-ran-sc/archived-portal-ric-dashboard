...
export class StatsComponent implements OnInit {
    ...
    load;
    delay;
    kibanaACxAppMetrics : SafeResourceUrl;
    ...
    ngOnInit() {
        ...
        this.service.getxPPMetricsUrl('ACXPP').subscribe((res:DashboardSuccessTransport) => {
            this.kibanaACxAppMetrics = this.sanitize.bypassSecurityTrustResourceUrl(res.data);
        });
    }
