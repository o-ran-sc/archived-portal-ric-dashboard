...
public class A1MediatorController {
	 ...
	 */
	@ApiOperation(value = "Gets the available policy types.")
	...
	@GetMapping(PP_POLICY_TYPES + "/{" + PP_POLICY_TYPE_ID + "}/" + PP_POLICIES)
	@Secured({ DashboardConstants.ROLE_ADMIN, DashboardConstants.ROLE_STANDARD })
	...
	@ApiOperation(value = "Returns a policy instance of the given type with the given ID.")
	@GetMapping(PP_POLICY_TYPES + "/{" + PP_POLICY_TYPE_ID + "}/" + PP_POLICIES + "/{" + PP_POLICY_INSTANCE_ID
			+ "}")
	@Secured({ DashboardConstants.ROLE_ADMIN, DashboardConstants.ROLE_STANDARD })
	...
	@PutMapping(PP_POLICY_TYPES + "/{" + PP_POLICY_TYPE_ID + "}/" + PP_POLICIES + "/{" + PP_POLICY_INSTANCE_ID
			+ "}")
	...
	@DeleteMapping(PP_POLICY_TYPES + "/{" + PP_POLICY_TYPE_ID + "}/" + PP_POLICIES + "/{"
