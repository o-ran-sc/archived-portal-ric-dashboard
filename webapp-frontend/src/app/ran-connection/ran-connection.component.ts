...
import { AppRANConnectDialogComponent } from './ran-connection.component.dialog';
import { E2ManagerService } from '../services/e2-mgr/e2-mgr.service';
import { E2SetupRequest } from '../interfaces/e2-mgr.types';
import { RANConnectionsDataSource } from './ran-connection.datasource';
...
export class RanConnectionComponent implements OnInit {
  ...
  dataSource: RANConnectionsDataSource;

  constructor(private e2MgrSvc: E2ManagerService, public dialog: MatDialog) { }

  ngOnInit() {
    this.dataSource = new RANConnectionsDataSource(this.e2MgrSvc);
